			...
			<div class="widget-body">
				<div class="col-lg-12">
					<div class="form-container">
		          		<?php $attributes = array('name' => 'assign_class', 'id' => 'assign_class','class'=>'form-container'); echo form_open('', $attributes);?>
			               	<input type="hidden" value="<?php if($this->uri->segment(2)){ echo $this->uri->segment(2);} ?>" name="serial" id="serial">
		                	<fieldset>
			                    <div class="field-container ">
			                		<div class="upper-row">
			                			<label><span class="icon-user"></span> Info <span class="required">*</span></label>
			                		</div>
			                		<div class="field-row">
			                			<div class="left-column">
			                				<select>
			                					<option>Haleem</option>
			                					<option>Sam</option>
			                					<option>Sajawal</option>
			                    ...
			                    <div class="field-container">
			                		<div class="upper-row">
			                			<label><span class="icon-phone"></span> Year<span class="required">*</span></label>
			                		</div>
			                		<div class="field-row">
			                			<div class="left-column">
			                				<select>
