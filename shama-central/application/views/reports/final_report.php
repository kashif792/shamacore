     ...
     $scope.baseUrl = '<?php echo base_url() ?>'
        ...
        function loadSections()
        {
            try{
                ...
                $myUtils.httprequest('<?php echo SHAMA_CORE_API_PATH; ?>sections_by_class',({class_id:$scope.filterobj.class.id,school_id:$scope.school_id})).then(function(response){
      ...
      $scope.download = function()
        {
            ...
            if($scope.filterobj.semester.id == 'b')
            {
             ...
             pdfMake.createPdf(reportobj).download(filename+".pdf");
        }
        ...
        $scope.getGradedata = function()
        {
            ...
            $myUtils.httppostrequest('<?php echo SHAMA_CORE_API_PATH; ?>final_student_report',data).then(function(response){
