         ...
         <div class="modal-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <th>Holiday</th>
                        <td>
                           <span ng-hide="holidays.is_all_day == true">Yes</span>
                           <span ng-hide="holidays.is_all_day == false">No</span>
                        </td>
                    </tr>
...
<script type="text/javascript">
  ...
  return function(text){
    ...
    app.controller('CalendarCtrl', function ($scope,$compile,$http,$filter,$modal,$rootScope) {
        ...
        function createcalendar()
        {
            $('#calendar').fullCalendar({
                ...
                eventClick: function (calEvent, jsEvent) {
                    ...
                    $scope.holidays.is_all_day = calEvent.allDay;
