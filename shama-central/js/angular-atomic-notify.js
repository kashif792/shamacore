...
angular
    ...
    .directive('ngAtomicNotify', ['$compile', '$timeout', function($compile, $timeout){
        ...
        var link = function($scope, element, attr){
            var template = '<div class="atomic-notify"><div class="atomic-notify-item" ng-repeat="item in items" ng-class="discoverClass(item)"><div class="body"><p>{{item.text}}</p></div></div></div>';
