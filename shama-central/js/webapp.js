...
app.config(function($routeProvider,$locationProvider) {
    ...
    .when("/lesson/:classid/:sectionid", {
     ...
     .when("/cartoon", {
        templateUrl : "./application/views/webapplication/cartoon.php",
    })
...
app.factory('learningCommon',function($http,$localStorage,$sessionStorage){
    ...
    fac.shama_hostname_url = 'http://192.168.1.3/';
    fac.modes = [
...
*/
...

   {
...

    {
        ...
        delete fac.localStorage.shama_host;
...
app.controller('index_ctrl',function($scope,learningCommon,$cookieStore,$localStorage,$sessionStorage,$filter,$http,$sce){
    ...
    if(typeof $scope.commonobj.localStorage.shama_host == 'undefined')
    {
        check_shama_host();
    }

    function check_shama_host()
    {
        try{
            $http.get($scope.commonobj.shama_hostname_url+"shama_local_file.php",{}).then(function(r){
               if(r.status == 200)
               {
                    $scope.commonobj.localStorage.shama_host = true;
               }                                  
                else{
                    $scope.commonobj.localStorage.shama_host = false;
                }
            });
        }
        catch(e){
            ...
            $scope.commonobj.postrequest('getsubjectlistbyclassapi',data).then(function(response){
...

                {
                     ...
                     angular.forEach(response.message, function(value,key){
                        ...
                        var file_location = "upload/content/"+$scope.commonobj.localStorage.classinfo.classname+"/subjects/"+value.subject_name+".png";
                    ...
                    angular.forEach(response.message, function(value,key){
...

                        {
                            ...
                            if(value.content.endsWith('/')){
                                s = value.content.substring(0, value.content.length-1);
                                s = s.substring(s.lastIndexOf('/')+ 1);
                            }else{
                                s = value.content.substring(value.content.lastIndexOf('/')+ 1);
                            }
                            var file_location = "upload/content/"+$scope.commonobj.localStorage.classinfo.classname+"/"+$scope.params.subjectname+"/"+s.split('.')[0]+".png";
                            ...
                            var data = {'parent': baseUrl,
                                'back': $window.location.href,
                                'lessonid': value.id,
                                'classid':$localStorage.classinfo.classid,
                                'sectionid':$localStorage.classinfo.sectionid,
                                'type': (($scope.commonobj.localStorage.classinfo.mode == 2 || typeof $scope.commonobj.localStorage.classinfo.mode == 'undefined') ? 't':'r'),
                                'students' : temp
                            }

                            //console.log(angular.toJson(data));
                            value.content = value.content + '?'+ angular.toJson(data);
                        }
...
/*
app.directive('iframeDirective', ['$sce', function($scope, $sce) {
  return {
    restrict: 'E',
    template: '<iframe src="{{ trustedUrl }}" frameborder="0" allowfullscreen></iframe>',
    link: function(scope) {
      scope.trustedUrl = $scope.lessonobj.currentlesson.content;//$sce.trustAsResourceUrl("//www.youtube.com/embed/dQw4w9WgXcQ");
    }
  }
}]);
*/
        ...
        try{
...

            {
                ...
                if($scope.commonobj.localStorage.shama_host)
                {
                    ...
                    var file_name =$scope.commonobj.shama_hostname_url+"upload/content/"+$scope.commonobj.localStorage.classinfo.classname+"/"+$scope.commonobj.localStorage.subjectinfo.subjectname+"/"+split_file[(split_file.length - 1)];
...

            {
...

                {
...

                    {
                        ...
                        if($scope.lessonobj.currentlesson.type == 'Image' 
                            || $scope.lessonobj.currentlesson.type == 'Document' 
                            || $scope.lessonobj.currentlesson.type == 'Application' )
                        ...
                        else if($scope.lessonobj.currentlesson.type == 'Video')
...

                    {
                        ...
                        angular.forEach(response.result, function(value,key){
...

                            {
                                ...
                                try{
                                     var file_location = "upload/content/"+$localStorage.classinfo.classname+"/"+$scope.sessionobj.currentsessionperiod.subject+"/"+s.split('.')[0]+".png";
                                    if($scope.commonobj.localStorage.shama_host)
                                    {
                                        file_location = $scope.commonobj.shama_hostname_url+file_location;
                                    }
...
app.controller('cartoon_ctrl',function($scope,learningCommon,$cookieStore,$route, $routeParams,$location,$window,$localStorage,$sessionStorage){
    $scope.commonobj = learningCommon;
    $scope.sessionobj =  $scope.commonobj.getLocalStorage();
    $scope.loading = false;
    ...
    $scope.playvideo =function()
    {
        try{
            playerInstance.setup({
                autostart:'true',
                file: $scope.selectedcartoon.link,
                name:$scope.selectedcartoon.title,
                stretching: "exactfit",
                width: "100%",
                aspectratio: "24:10",
                image: "",
    ...
    $scope.todaycartoons = [
        {
            title: 'Ben 10 Omniverse - The Vampire Strikes Back (Preview) Clip 2',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            link:'https://cdnapisec.kaltura.com/p/1836881/sp/183688100/playManifest/entryId/0_znbw5v0s/flavorId/0_7zp6u5gf/format/url/protocol/https/a.mp4?referrer=aHR0cHM6Ly93d3cuY2FydG9vbm5ldHdvcmthc2lhLmNvbQ==&playSessionId=3b9089b1-5067-db2e-829f-343238ea49d4&clientTag=html5:v2.67&uiConfId=26993681',
            view_date: moment(),
            poster:'https://cfvod.kaltura.com/p/1836881/sp/183688100/thumbnail/entry_id/0_znbw5v0s/version/100002/acv/162/width/363/height/202/type/3/bgcolor/000000'
        },
        {
            title: 'The Tom And Jerry Show - Holed-Up (Preview)',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            link:'https://cdnapisec.kaltura.com/p/1836881/sp/183688100/playManifest/entryId/0_3a095y5f/flavorId/0_yizqtn98/format/url/protocol/https/a.mp4?referrer=aHR0cHM6Ly93d3cuY2FydG9vbm5ldHdvcmthc2lhLmNvbQ==&playSessionId=0bbab96c-8d94-9372-4b32-2317be48ab7c&clientTag=html5:v2.67&uiConfId=26993681',
            view_date: moment(),
            poster:'https://cdnsecakmi.kaltura.com/p/1836881/sp/183688100/thumbnail/entry_id/0_3a095y5f/version/100000/acv/102/width/363/height/202/type/3/bgcolor/000000'
        },
        {
            title: 'The Tom And Jerry Show - Cat Nippy (Preview) Clip 3',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            link:'https://cdnapisec.kaltura.com/p/1836881/sp/183688100/playManifest/entryId/0_3uhu2qdl/flavorId/0_137bxq3x/format/url/protocol/https/a.mp4?referrer=aHR0cHM6Ly93d3cuY2FydG9vbm5ldHdvcmthc2lhLmNvbQ==&playSessionId=c7f19d7e-a1db-8cf0-aed5-0cad4eae291d&clientTag=html5:v2.67&uiConfId=26993681',
            view_date: moment(),
            poster:'https://cdnsecakmi.kaltura.com/p/1836881/sp/183688100/thumbnail/entry_id/0_3uhu2qdl/version/100000/acv/112/width/363/height/202/type/3/bgcolor/000000'
        },
        {
            title: 'The Tom And Jerry Show - Cats Ruffled Furniture (Preview) Clip 2',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            link:'https://cdnapisec.kaltura.com/p/1836881/sp/183688100/playManifest/entryId/0_41fzkldn/flavorId/0_6qnt5i79/format/url/protocol/https/a.mp4?referrer=aHR0cHM6Ly93d3cuY2FydG9vbm5ldHdvcmthc2lhLmNvbQ==&playSessionId=bcf0d4d8-5aa8-c925-830b-ee4a8c5f88af&clientTag=html5:v2.67&uiConfId=26993681',
            view_date: moment(),
            poster:'https://cdnsecakmi.kaltura.com/p/1836881/sp/183688100/thumbnail/entry_id/0_41fzkldn/version/100000/acv/102/width/363/height/202/type/3/bgcolor/000000'
        },
        {
            title: 'The Tom And Jerry Show - Birthday Bashed (Preview) Clip 3',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            link:'https://cdnapisec.kaltura.com/p/1836881/sp/183688100/playManifest/entryId/0_484i2b24/flavorId/0_kf69j1qo/format/url/protocol/https/a.mp4?referrer=aHR0cHM6Ly93d3cuY2FydG9vbm5ldHdvcmthc2lhLmNvbQ==&playSessionId=33de55fb-c986-b0d1-569b-f0d4716caaf1&clientTag=html5:v2.67&uiConfId=26993681',
            view_date: moment(),
            poster:'https://cdnsecakmi.kaltura.com/p/1836881/sp/183688100/thumbnail/entry_id/0_484i2b24/version/100000/acv/112/width/363/height/202/type/3/bgcolor/000000'
        },
        {
            title: 'The Tom And Jerry Show - Cat Nippy (Preview) Clip 4',
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
            link:'https://cdnapisec.kaltura.com/p/1836881/sp/183688100/playManifest/entryId/0_57emn5r3/flavorId/0_58z7pbsk/format/url/protocol/https/a.mp4?referrer=aHR0cHM6Ly93d3cuY2FydG9vbm5ldHdvcmthc2lhLmNvbQ==&playSessionId=a0014f55-af8d-d218-8003-5ac97267c309&clientTag=html5:v2.67&uiConfId=26993681',
            view_date: moment(),
            poster:'https://cdnsecakmi.kaltura.com/p/1836881/sp/183688100/thumbnail/entry_id/0_41fzkldn/version/100000/acv/102/width/363/height/202/type/3/bgcolor/000000'
        },
    ];

    $scope.selectedcartoon = null;

    $scope.currentindex = Math.floor((Math.random() * $scope.todaycartoons.length) + 1) - 1;
    $scope.selectedcartoon = $scope.todaycartoons[$scope.currentindex];
    $scope.playvideo();

    $scope.playcartoon = function(c)
    {
